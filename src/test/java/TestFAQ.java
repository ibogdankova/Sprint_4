...
public class TestFAQ {
    ...
    // Конструктор параметризованных данных
    public TestFAQ(String headingIndex, String expectedAnswer) {
        this.headingIndex = headingIndex;
        this.expectedAnswer = expectedAnswer;
    }

    // Набор данных для теста (индекс вопроса, ожидаемый текст ответа)
    ...
    public void testFAQ() {
        ...
        // Получение реального ответа с сайта
        String actualAnswer = homePage.getAnswerText(headingIndex);

        // Сравнение с ожидаемым значением
        homePage.verifyAnswer(headingIndex, expectedAnswer);
    }
